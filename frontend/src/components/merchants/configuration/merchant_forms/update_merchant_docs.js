...
export default function UpdateMerchantDocs ({docs, setUploadedDocs, uploadText, uploadLimit}) {
    const uplaodedDocs = docs?.map(doc => {
        ...
        return (
            ...
            >
                <Typography variant='h6' fontSize={12} fontWeight="bold">{doc.name || doc}</Typography>
